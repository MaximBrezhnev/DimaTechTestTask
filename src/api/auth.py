...
from src.schemas.schemas import OAuth2PasswordRequestFormEmail
...
async def login(
    ...
    в заголовке вида Authorization: Bearer <access token>, и refresh token, необходимый для обновления имеющего
